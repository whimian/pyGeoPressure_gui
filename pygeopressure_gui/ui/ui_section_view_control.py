...
class Ui_section_View_Control(object):
    def setupUi(self, section_View_Control):
        ...
        self.colormap_ComboBox = QtGui.QComboBox(self.groupBox)
        self.colormap_ComboBox.setGeometry(QtCore.QRect(20, 210, 91, 22))
        self.colormap_ComboBox.setObjectName(_fromUtf8("colormap_ComboBox"))
        self.wiggle_CheckBox = QtGui.QCheckBox(self.groupBox)
        self.wiggle_CheckBox.setGeometry(QtCore.QRect(10, 180, 91, 17))
        self.wiggle_CheckBox.setObjectName(_fromUtf8("wiggle_CheckBox"))
    ...
    def retranslateUi(self, section_View_Control):
        ...
        self.wiggle_CheckBox.setText(_translate("section_View_Control", "Wiggle Trace", None))
